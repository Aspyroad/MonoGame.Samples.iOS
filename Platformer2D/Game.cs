...
namespace Platformer2D
{
    ...
    public class PlatformerGame : Microsoft.Xna.Framework.Game
    {
        ...
        private void HandleInput(GameTime gameTime)
        {
            ...
            //gamePadState = virtualGamePad.GetState(touchState, GamePad.GetState(1));
...
#endif
            bool continuePressed = keyboardState.IsKeyDown(Keys.Space) || gamePadState.IsButtonDown(Buttons.A) || touchState.AnyTouch();
